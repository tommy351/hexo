...
function openGraphHelper(options) {
  ...
  if (options.twitter_player) {
    result += meta('twitter:player', options.twitter_player);
    result += meta('twitter:player:width', options.twitter_player_width || 960);      
    result += meta('twitter:player:height', options.twitter_player_height || 720);
  }
